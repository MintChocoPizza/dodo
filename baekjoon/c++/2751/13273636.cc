// clang++ -O2 solution.cc -lm -static -Wall -Wextra -Wpedantic -Werror -std=c++17
//
// Reference:
...
int main() {
  ...
  // stdin mmap 수행
  //
  u8 * const input = (u8*)mmap(NULL, file_size, PROT_READ | PROT_WRITE, MAP_PRIVATE, STDIN_FILENO, 0);
